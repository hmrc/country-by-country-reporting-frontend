...
class FilePassedChecksControllerISpec extends ISpecBehaviours {

  private val pageUrl: Option[String] = Some("/file-passed-checks")

  "FilePassedChecksController" must {
    ...
    behave like pageLoads(pageUrl, "filePassedChecks.title", ua)
