...
import views.html.{FileErrorView, FileProblemVirusView}

class FileErrorViewSpec extends SpecBase with Injecting with ViewHelper {

  implicit private val request: FakeRequest[AnyContent] = FakeRequest()

  private def setupDoc = {
    val view: FileErrorView                                               = inject[FileErrorView]
